...
def main():
    ...
    s4 = Sphere3(*point_o5, radius=robot.y1)
    ...
    x_plus = c4.at_angle(theta).point - c4.center   # Get a vector from the "lowest" point in the circle to its center
    ...
    reduced = Iso3.from_basis_xz(c3.plane.project_vector(x_plus), -z_minus, c3.center).inverse()

     # Get the other parameters to see how we did
    r_3 = c3.r
    h =
    ...
    if PLOT_ROBOT_SETUP:
        ...
        plotter.circle(c4, edge_color="red", face_color=None, edge_width=1.5)
        plotter.sphere(s4, color="red", opacity=0.1)
        plotter.sphere(s3, color="orange", opacity=0.1)
        plotter.sphere(s1, color="green", opacity=0.1)
        plotter.circle(c3, n=1000, edge_color="blue", face_color=None, edge_width=1.5)
    ...
    if PLOT_REDUCED:
        ...
        o3_circle_r: Circle3 = reduced @ c3
        o4_circle_r: Circle3 = reduced @ c4
